  ...
  return {
    ...
    workspaceProps: {
      ...
      settingsViewProps: {
        ...
        extractionStrategyModelsDraft: aiGeneration.extractionStrategyModelsDraft,
        extractionRuntimeDraft: aiGeneration.extractionRuntimeDraft,
        ...
        onSetExtractionStrategyModelsDraft: aiGeneration.setExtractionStrategyModelsDraft,
        onSetExtractionRuntimeDraft: aiGeneration.setExtractionRuntimeDraft,
