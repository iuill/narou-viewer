...
export function useAiGeneration({
  ...
  return {
    ...
    characterSummaryStrategyModelsDraft: settings.characterSummaryStrategyModelsDraft,
    ...
    selectedProfileId: settings.selectedProfileId,
    setActiveView,
    setCharacterSummaryStrategyModelsDraft: settings.setCharacterSummaryStrategyModelsDraft,
