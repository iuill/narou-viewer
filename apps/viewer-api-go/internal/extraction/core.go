...
func Limits() (int, int) {
	return PositiveEnvInt("CHARACTER_SUMMARY_MAX_CHUNK_CHARS", defaultExtractionMaxChunkChars),
		PositiveEnvInt("CHARACTER_SUMMARY_MAX_BATCH_CHARS", defaultExtractionMaxBatchChars)
}
