...
const (
	defaultCharacterSummaryMaxChunkChars = 4000
	defaultCharacterSummaryMaxBatchChars = 12000
)
...
func Limits() (int, int) {
	return PositiveEnvInt("CHARACTER_SUMMARY_MAX_CHUNK_CHARS", defaultCharacterSummaryMaxChunkChars),
		PositiveEnvInt("CHARACTER_SUMMARY_MAX_BATCH_CHARS", defaultCharacterSummaryMaxBatchChars)
}
