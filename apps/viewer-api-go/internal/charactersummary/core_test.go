...
func TestCharacterSummaryPromptCompactsUnresolvedMentions(t *testing.T) {
...
func TestCharacterSummaryApplyDeltaMergesByStableIDOnly(t *testing.T) {
...
func TestCharacterSummaryApplyDeltaMergesDuplicateNewCharactersBeforeIDAllocation(t *testing.T) {
...
func TestCharacterSummaryApplyDeltaDoesNotMergeGenericNewCharactersBeforeIDAllocation(t *testing.T) {
...
func TestCharacterSummaryApplyDeltaMergeProposalsAreOrderIndependent(t *testing.T) {
	existing := []characters.GeneratedCharacter{
...
func TestCharacterSummaryApplyDeltaCanonicalUpdateUsesNewerName(t *testing.T) {
	existing := []characters.GeneratedCharacter{{
...
func TestCharacterSummaryRuntimePlanningSplitsAndReturnsRemaining(t *testing.T) {
	batch := Batch{
		BatchIndex: 1,
		BatchCount: 1,
		Chunks: []Chunk{
...
func TestCharacterSummaryResolveBatchBudgetUsesModelContext(t *testing.T) {
...
func TestCharacterSummaryUnresolvedMentionsMergeAndFilter(t *testing.T) {
